...
#output directory
OUTPUT=/storage/group/bfp2/default/juk398-JordanKrebs/NucleosomeAtlas_project/231017_Encode_motif/output
...
sampleID=ATF7_ENCODE_Intersect_PileUp_lowlyBound_v4_231018.slurm
rm -f $sampleID
...
echo "rm $TARGET_lowlyBound_1000bp" >> $sampleID

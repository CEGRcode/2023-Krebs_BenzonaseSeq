# purpose - code for Fig. 5 updated to have a max insert size of 80bp to show sub-nucleosomal reads for BNase-ChIP-exo. This uses all +1 positions (11,714) and now includes MNase ChIP-seq for H3K4me3. This version (v2) uses all sites for composite plots.
...
#output directory
OUTPUT=/storage/group/bfp2/default/juk398-JordanKrebs/NucleosomeAtlas_project/figures/fig4_5_new_subnucleosomes/Fig5_ChIPs_+1_max80bp_MNase_output_240305
...
BAM11=/storage/group/bfp2/default/juk398-JordanKrebs/NucleosomeAtlas_project/240215_MNase_data/final_merged_files/SRR6010180_SRR6010175_SRR6010177_SRR7441419_SRR7441420_dedup_MERGE_master.bam
...
sampleID=fig5_plus1_max80bp_MNase_v2_240305_ROAR.slurm
rm -f $sampleID
...
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT1 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT1 --max-insert=80 $BEDFILE_2000 $BAM1" >> $sampleID
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT2 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT2 --max-insert=80 $BEDFILE_2000 $BAM2" >> $sampleID
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT3 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT3 --max-insert=80 $BEDFILE_2000 $BAM3" >> $sampleID
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT4 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT4 --max-insert=80 $BEDFILE_2000 $BAM4" >> $sampleID
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT5 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT5 --max-insert=80 $BEDFILE_2000 $BAM5" >> $sampleID
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT6 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT6 --max-insert=80 $BEDFILE_2000 $BAM6" >> $sampleID
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT7 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT7 --max-insert=80 $BEDFILE_2000 $BAM7" >> $sampleID
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT8 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT8 --max-insert=80 $BEDFILE_2000 $BAM8" >> $sampleID
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT9 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT9 --max-insert=80 $BEDFILE_2000 $BAM9" >> $sampleID
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT10 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT10 --max-insert=80 $BEDFILE_2000 $BAM10" >> $sampleID
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT11 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT11 --max-insert=80 $BEDFILE_2000 $BAM11" >> $sampleID
...
echo "java -Djava.awt.headless=true -jar $SCRIPTMANAGER figure-generation heatmap -o=$PNG11 -c 000000 -p=0.95 $CDT11_SCALED" >> $sampleID
...
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT1d_3000 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT1a_3000 --max-insert=80 $BEDFILE_3000 $BAM1" >> $sampleID
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT2d_3000 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT2a_3000 --max-insert=80 $BEDFILE_3000 $BAM2" >> $sampleID
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT3d_3000 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT3a_3000 --max-insert=80 $BEDFILE_3000 $BAM3" >> $sampleID
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT4d_3000 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT4a_3000 --max-insert=80 $BEDFILE_3000 $BAM4" >> $sampleID
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT5d_3000 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT5a_3000 --max-insert=80 $BEDFILE_3000 $BAM5" >> $sampleID
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT6d_3000 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT6a_3000 --max-insert=80 $BEDFILE_3000 $BAM6" >> $sampleID
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT7d_3000 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT7a_3000 --max-insert=80 $BEDFILE_3000 $BAM7" >> $sampleID
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT8d_3000 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT8a_3000 --max-insert=80 $BEDFILE_3000 $BAM8" >> $sampleID
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT9d_3000 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT9a_3000 --max-insert=80 $BEDFILE_3000 $BAM9" >> $sampleID
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT10d_3000 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT10a_3000 --max-insert=80 $BEDFILE_3000 $BAM10" >> $sampleID
echo "java -jar $SCRIPTMANAGER read-analysis tag-pileup -m -z --combined --output-matrix=$CDT11d_3000 -N -p --cpu=4 --blacklist-filter=$BLACKLIST -o=$OUT11a_3000 --max-insert=80 $BEDFILE_3000 $BAM11" >> $sampleID

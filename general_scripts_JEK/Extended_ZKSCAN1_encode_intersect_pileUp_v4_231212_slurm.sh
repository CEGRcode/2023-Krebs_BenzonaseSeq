# purpose - intersect bedfile of all sites for a motif with encode-called peaks (Bed narrowPeak bedfile). Then sort by column 7 of the encode peak. Take the bottom 1/2 of 'bound sites' and look at BNase-seq at the 'lowly bound sites' **same code as used for Fig. 5 except that lowly bound bedfile is now NOT removed.
...
BEDFILE=/storage/group/bfp2/default/juk398-JordanKrebs/NucleosomeAtlas_project/231017_Encode_motif/extended_ZKSCAN1_motif_231211/final_bedfiles/MA1585_1_final_1000bp_intersected_lowlyBound_1000bp_motif1_meme_1000bp_shifted_final_1000bp.bed

#output directory
OUTPUT=/storage/group/bfp2/default/juk398-JordanKrebs/NucleosomeAtlas_project/231017_Encode_motif/extended_ZKSCAN1_motif_231211/benzonase_output
...
sampleID=ext_ZKSCAN1_ENCODE_Intersect_PileUp_lowlyBound_v4_231212.slurm
rm -f $sampleID
